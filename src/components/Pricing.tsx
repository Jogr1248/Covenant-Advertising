  ...
  const packages = [
    {
      ...
      frequency: 'Ads run every 10 days',
      popular: false
    },
    {
      name: 'Silver',
      ...
      frequency: 'Ads run every 5 days',
      popular: false
    },
    {
      name: 'Gold',
      ...
      frequency: 'Ads run every 3 days',
      popular: true
    },
    {
      name: 'Diamond',
      ...
      frequency: 'Ads run every 2 days',
      popular: false
    },
    {
      name: 'Platinum',
            ...
            >
              ...
              <div className="space-y-4 mb-6">
                <div className="bg-white/10 rounded-lg p-4 text-center">
                  ...
                  <div className="text-lg font-bold text-white whitespace-nowrap">{pkg.audience}</div>
                </div>
